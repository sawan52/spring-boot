package com.sawan.rest.fileprocessing;
...
class RestfileprocessingApplicationTests {
	...
	private static final String DOWNLOAD_PATH = "C:\\Users\\SawanSingh\\Downloads\\";
	...
	void testUpload() {
		...
		body.add("file", new ClassPathResource("gate2022_application.jpg"));
	...
	void testDownload() throws IOException {
		...
		String fileName = "gate2022_application.jpg";
